...
public abstract class SlidingActivityGroup extends ActivityGroup implements SlidingActivityBase {
	...
	public View switchActivity(String tag, Intent intent) {
		Window window = this.getLocalActivityManager().startActivity(tag, intent);
