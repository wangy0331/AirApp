...
public class BaojingListActivity extends BaseActivity {
    ...
    private void initData() {
        mAdapter = new BaojingListAdapter(BaojingListActivity.this);
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                try {
                    ...
                    Intent intent = new Intent(BaojingListActivity.this,
                            BaojingDetailActivity.class);
    ...
    class DeviceListTask extends AsyncTask<Void, Void, Result<List<Device>>> {
        ...
        public DeviceListTask(String content, String condition) {
            ...
            mLoadDialog = new LoadProcessDialog(BaojingListActivity.this);
        }
        ...
        protected Result<List<Device>> doInBackground(Void... params) {
            try {
                return ServiceCenter.deviceBj(mCondition, mContent);
            } catch (Exception e) {
                e.printStackTrace();
            }
            return null;
        ...
        protected void onPostExecute(Result<List<Device>> result) {
            ...
            if (result != null) {
                if (result.isSuceed()) {
                    ...
                    Toast.makeText(BaojingListActivity.this, R.string.device_failure, Toast.LENGTH_SHORT).show();
                }

            } else {
                Toast.makeText(BaojingListActivity.this, R.string.member_register_network, Toast.LENGTH_SHORT).show();
            }
        }
    }
}
