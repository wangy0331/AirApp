...
public class WeixiuAdapter extends ArrayAdapter<Device> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.coName = (TextView) convertView.findViewById(R.id.co_name_wx);
            holder.icon = (TextView) convertView.findViewById(R.id.jq_icon_wx);
            holder.jiqiSn = (TextView) convertView.findViewById(R.id.jiqi_sn_wx);
            holder.scBtn = (Button) convertView.findViewById(R.id.shoucang_btn_wx);
            holder.nscBtn = (Button) convertView.findViewById(R.id.not_shoucang_btn_wx);
            holder.mTime = (TextView) convertView.findViewById(R.id.time_wx);
            holder.mTemp = (TextView) convertView.findViewById(R.id.wendu_wx);
