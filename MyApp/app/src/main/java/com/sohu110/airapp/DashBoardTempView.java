 ...
 * 
 */
public class DashBoardTempView extends View {
...
//	private static final String CURRENT_SPEED = "";
	...
	public DashBoardTempView(Context context) {
		super(context);
		init(context);
	}

	public DashBoardTempView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	public DashBoardTempView(Context context, AttributeSet attrs, int defStyle) {
	...
	private void fixedTextDraw(Canvas canvas) {
		...
		canvas.drawText(FIXED_SPEED_LEVEL[9], 84 * view_width / BGPIC_WIDTH,
				19 * view_width / BGPIC_WIDTH, mFixedTextPaint);
