 ...
 */
public class WeixiuDetailActivity extends BaseActivity {
    ViewPager mViewPager;
    WeixiuDetailAdapter mAdapter;
    ...
    private void initView() {
        ...
        mAdapter = new WeixiuDetailAdapter(getSupportFragmentManager(), mDevice.getJiqiSn());
