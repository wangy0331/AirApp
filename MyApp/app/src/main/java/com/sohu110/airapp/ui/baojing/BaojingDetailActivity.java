 ...
 */
public class BaojingDetailActivity extends BaseActivity {

    ViewPager mViewPager;
    BaojingDetailAdapter mAdapter;
    ...
    private void initView() {
        ...
        mAdapter = new BaojingDetailAdapter(getSupportFragmentManager(), mDevice.getJiqiSn());
